...
/// ```
/// {
///     let _cleaner = ::config_file_handler::file_handler::ScopedUserAppDirRemover;
///     let file_handler = ::config_file_handler::file_handler
///                             ::FileHandler::new("test.json").unwrap();
